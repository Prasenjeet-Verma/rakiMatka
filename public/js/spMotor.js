document.addEventListener("DOMContentLoaded", () => {
  ...
  const sessionRadios = main.querySelectorAll('input[name="spmotor_session"]');
  const openDigitInput = document.getElementById("spmotor_opendigit");
  ...
  // ✅ Bottom bar
  const bidsDisplay = {
    totalBids: main.querySelector('.spmotor_totalbids'),
    totalAmount: main.querySelector('.spmotor_totalamount')
  };
  ...
  function checkOpenLock() {
    ...
    if (serverTime >= openTime) {
      ...
      const checked = main.querySelector('input[name="spmotor_session"]:checked');
  ...
  addBtn.addEventListener("click", () => {
    const session = main.querySelector('input[name="spmotor_session"]:checked')?.nextElementSibling.innerText;
