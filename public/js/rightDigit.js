document.addEventListener("DOMContentLoaded", () => {
  ...
  const openBtn = document.getElementById("btnOpenRightDigit");
  const closeBtn = document.getElementById("closeRightDigitBulk");

  const openInput = document.getElementById("rightDigit_openDigit");
  const pointsInput = document.getElementById("rightDigit_points");
  const addBtn = document.getElementById("rightDigit_addBtn");
  const submitBtn = document.getElementById("rightDigit_submitBtn");

  const tableBody = document.getElementById("rightDigitLiveBets");
  const totalBidsEl = document.getElementById("rightDigit_totalBids");
  const totalAmountEl = document.getElementById("rightDigit_totalAmount");
